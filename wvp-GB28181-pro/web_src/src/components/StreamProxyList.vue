<template>
    ...
    <div class="page-header">
      ...
      <div class="page-header-btn">
        <el-button icon="el-icon-plus" size="mini" style="margin-right: 1rem;" type="primary" @click="multiYolo">yolo分析</el-button>
    ...
    <MultiPlay ref="child" :rtmp_list="rtmp_list"></MultiPlay>
...
<script>
  ...
  import MultiPlay from './dialog/multiPlay.vue'
	export default {
    ...
    MultiPlay,
        ...
        this.$axios({
          ...
          if (res.data.code === 0) {
            for (let i = 0; i < res.data.data.list.length; i++) {
              that.rtmp_list.push(res.data.data.list[i]['dstUrl'])
            }
          }
          console.log(that.rtmp_list);
          console.log("************");
      ...
      multiYolo: function(){
        console.log("this is a multiplayer test");
