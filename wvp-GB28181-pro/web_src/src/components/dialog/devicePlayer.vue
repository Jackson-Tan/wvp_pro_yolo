...
<!--          </el-tab-pane>-->
          ...
          <el-tab-pane label="Yolo" name="yoloview">
            <yoloView v-if="activePlayer === 'yoloview'" ref="yoloview" :visible.sync="showVideoDialog" :videoUrl="streamInfo.rtmp" :error="videoError" :message="videoError" height="100px" :hasAudio="hasAudio" fluent autoplay live ></yoloView>
          </el-tab-pane>
        </el-tabs>
        ...
        <yoloView v-if="Object.keys(this.player).length == 1 && this.player.yolo" ref="yoloviewx" :visible.sync="showVideoDialog" :videoUrl="streamInfo.rtmp" :error="videoError" :message="videoError" height="100px" :hasAudio="hasAudio" fluent autoplay live ></yoloView>
...
import yoloView from '../dialog/yoloView.vue';
export default {
    name: 'devicePlayer',
    props: {},
    components: {
    LivePlayer, jessibucaPlayer, rtcPlayer, yoloView,
},
    computed: {
